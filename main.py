...
# # Send welcome message to admin when bot starts
# async def send_admin_welcome(application):
#     try:
#         keyboard = [[InlineKeyboardButton("🔍 لوحة التحكم", callback_data="admin_dashboard")]]
#         reply_markup = InlineKeyboardMarkup(keyboard)
        
#         await application.bot.send_message(
#             chat_id=ADMIN_ID,
#             text="مرحباً بالإدارة! 👋\nتم تشغيل البوت بنجاح وهو جاهز للاستخدام.",
#             reply_markup=reply_markup
#         )
#         logger.info(f"Welcome message sent to admin (ID: {ADMIN_ID})")
#     except Exception as e:
#         logger.error(f"Failed to send welcome message to admin: {e}")
...
#     # Send welcome message to admin when bot starts
#     application.post_init = send_admin_welcome
